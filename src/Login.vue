<template>
  <el-form class="login-container" label-width="0px"
    ...
    <el-form-item>
      <el-button type="primary" class="login_button" v-on:click="login">登录</el-button>
    </el-form-item>
    <el-form-item>
      <el-button type="warning" class="login_button" v-on:click="regis">注册</el-button>
    </el-form-item>
  </el-form>
</template>
        ...
        .then(successResponse => {
          ...
          if (successResponse.data.code === 200) {
            _this.$store.commit({
              ...
              userId: successResponse.data.result,
